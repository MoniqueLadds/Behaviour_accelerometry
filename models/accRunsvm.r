accRun <- function(featureData,
  ...
  uEventIds <- unique(as.character(featureData$EventIds))
  if(codeTest){
    classMax <- 200
    K <- 2
  }else{
             ...
             switch(Kernel,
                    ...
                    "sigmoid" = {
                      paramList <-  expand.grid(gamma = 10 ^ seq(from = -4, to = 5, by = 2),
                                                ...
                                                cost = 10 ^ seq(from = -4, to = 5, by = 2))                    }
#                     "linear" = {
#                       paramList <-  data.frame(cost = 10 ^ seq(from = -5, to = 5, by = 2))
#                     },
#                     "polynomial" = {
#                       paramList <-  expand.grid(degree = seq(from = 0, to = 4, by = 2),
#                                                 gamma = 10 ^ seq(from = -4, to = 3, by = 2),
#                                                 coef0 = seq(from = 0, to = 4, by = 2),
#                                                 cost = 10 ^ seq(from = -4, to = 3, by = 2))
#                     },
#                     "radial" = {
#                       paramList <-  expand.grid(gamma = 10 ^ seq(from = -5, to = 5, by = 2),
#                                                 cost = 10 ^ seq(from = -5, to = 5, by = 2))
#                     },
#                     "sigmoid" = {
#                       paramList <-  expand.grid(gamma = 10 ^ seq(from = -4, to = 3, by = 2),
#                                                 coef0 = seq(from = 0, to = 4, by = 2),
#                                                 cost = 10 ^ seq(from = -4, to = 3, by = 2))                    }
             )             
           }
