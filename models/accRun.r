accRun <- function(featureData,
  ...
  if(SAVE){
    ...
    #mainDir <- getwd()
    if(codeTest){
      subDir <- "I:/Behaviour accelerometry/behaviour_accelerometry-master/model_outputs/test/"
    }
    else{
      subDir <- "I:/Behaviour accelerometry/behaviour_accelerometry-master/model_outputs/"
    }
